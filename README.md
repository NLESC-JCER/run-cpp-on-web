...
1. My C++ program needs sockets, can I use those? Explain limitations of Emscripten, use web socket and in-memory filesystem as examples
1. How to build WebAssembly with a dependencies like boost, explain bundled standard libs and https://github.com/emscripten-ports
